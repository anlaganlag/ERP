...
public class StationManualAllocationAllocResult implements Serializable {
    ...
    @ExcelProperty(value= "Storage Fee原值")
    ...
    /** 结算报告库容费(即站内分摊的仓储费) */
    private BigDecimal stlStorageFee;
    /** 库容费原值或业务值(月仓储费+长期仓储费的业务值) */
    private BigDecimal oriStorageFee;
    private BigDecimal storageAllocRation;
    /** 结算值和原值的比值 无原值就是1全部结算 */
    private BigDecimal oriStorageOverageFee;

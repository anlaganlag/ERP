...
public class SettlementReportFinalResult implements Serializable, BaseValidatingParam {
    ...
    @ApiModelProperty(value ="亚马逊分摊人数")
    private BigDecimal amazonAlloc;


    @ApiModelProperty("明细净销售额")
    private BigDecimal detailsalesvol;

    @ApiModelProperty("Team净销售额")
    private BigDecimal teamsalesvol;

    @ApiModelProperty("分摊架构ID")
    private String structId;


    @ApiModelProperty("分摊架构期间")
    private String period;


    @ApiModelProperty("分摊架构三级级部门")
    private String dept3;

    @ApiModelProperty("分摊架构四级部门")

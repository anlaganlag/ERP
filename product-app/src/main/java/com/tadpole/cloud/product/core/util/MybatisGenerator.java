...
public class MybatisGenerator {
  ...
  public static void main(String[] args) {
    ...
    gc.setOutputDir(projectPath + "/product-app/src/main/java");
...
//    strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
    strategy.setInclude("RD_MANAGE_UP_RECORD");
...
//    strategy.setTablePrefix("STOCK_"); //生成实体时去掉表前缀
    ...
    pc.setParent("com.tadpole.cloud.product.modular." + ModuleName);
...
//                return projectPath + "/src/main/resources/mappers/" + pc.getModuleName()
        return projectPath + "/product-app/src/main/java/com/tadpole/cloud/product/modular/"
                + ModuleName

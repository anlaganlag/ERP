...
*/
@RestController
@ApiResource(name = "开发预案", path = "/developPlan")
@Api(tags = "开发预案")
public class DevelopPlanController {
    ...
    @PostResource(name = "开发预案-列表查询", path = "/listPage", menuFlag = true)
    @ApiOperation(value = "开发预案-列表查询")
    @BusinessLog(title = "开发预案-列表查询",opType = LogAnnotionOpTypeEnum.QUERY)
    public ResponseData listPage(@RequestBody RdPreProposalParam param) {
        param.setSysYaScene(RdPreProposalEnum.YA_SCENE_DEV.getName());
        return ResponseData.success(this.rdPreProposalService.listPage(param));
    }

    @PostResource(name = "开发预案-创建/编辑预案", path = "/addOrEdit")
    @ApiOperation(value = "开发预案-创建/编辑预案")
    @BusinessLog(title = "开发预案-创建/编辑预案",opType = LogAnnotionOpTypeEnum.ADD)
    public ResponseData addOrEdit(@RequestBody RdPreProposalParam param) {
        param.setSysYaScene(RdPreProposalEnum.YA_SCENE_DEV.getName());
        return this.rdPreProposalService.addOrEdit(param);
    }

    @PostResource(name = "开发预案-详情", path = "/detail")
    @ApiOperation(value = "开发预案-详情")
    @BusinessLog(title = "开发预案-详情",opType = LogAnnotionOpTypeEnum.DETAIL)
    ...
    @PostResource(name = "开发预案-申请", path = "/apply")
    @ApiOperation(value = "开发预案-申请")
    @BusinessLog(title = "开发预案-申请",opType = LogAnnotionOpTypeEnum.UPDATE)
    public ResponseData apply(@RequestBody RdPreProposalParam param) {
        param.setSysYaScene(RdPreProposalEnum.YA_SCENE_DEV.getName());
        return this.rdPreProposalService.apply(param);
    }

    @PostResource(name = "开发预案-归档", path = "/archive")
    @ApiOperation(value = "开发预案-归档")
    @BusinessLog(title = "开发预案-归档",opType = LogAnnotionOpTypeEnum.UPDATE)
    public ResponseData archive(@RequestBody RdPreProposalParam param) {
        return this.rdPreProposalService.archive(param);
    }

    @PostResource(name = "开发预案-撤销", path = "/revoke")
    @ApiOperation(value = "开发预案-撤销")
    @BusinessLog(title = "开发预案-撤销",opType = LogAnnotionOpTypeEnum.UPDATE)

...
public class ProductPlanGenerator {
    ...
    public static void main(String[] args) {
        ...
        //包名
        String ModuleName = "productproposal";
        // 生成的表名 scanner("表名，多个英文逗号分割").split(",")
        String[] tables = "RD_PROPOSAL,RD_PROPOSAL_DOC".toUpperCase().split(",");
        //项目包名
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("database","product" );//ServerImpl 数据源名称

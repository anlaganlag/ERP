...
public class FinanceGenerator {
  ...
  public static void main(String[] args) {
    ...
    gc.setOutputDir(projectPath + "/platformSettlement-app/src/main/java");
    ...
    dsc.setUrl(
        "jdbc:oracle:thin:@test.jcintergl.com:1521/ORCLPDB1");
    dsc.setDriverName("oracle.jdbc.driver.OracleDriver");
    dsc.setUsername("finance");
    dsc.setPassword("Bsc_Test001");
...
//    strategy.setTablePrefix("RP_");
    ...
    strategy.setInclude(("MONITOR_GOOGDWILL").split(","));
...
//           strategy.setTablePrefix("STOCK_");                          //生成实体时去掉表前缀
    ...
    pc.setParent("com.tadpole.cloud.platformSettlement.modular." + ModuleName);
...
//                return projectPath + "/src/main/resources/mappers/" + pc.getModuleName()
        return projectPath + "/platformSettlement-app/src/main/java/com/tadpole/cloud/platformSettlement/modular/"
                + ModuleName
    ...
    focList.add(new FileOutConfig(paramTemplatePath) {
      ...
      @Override
      public String outputFile(TableInfo tableInfo) {
        return projectPath + "/platformSettlement-api/src/main/java/com/tadpole/cloud/platformSettlement/api/"
                + ModuleName

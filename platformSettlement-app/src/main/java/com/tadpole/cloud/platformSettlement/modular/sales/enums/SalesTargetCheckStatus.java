 ...
 */
@Getter
public enum SalesTargetCheckStatus {
    ...
    SalesTargetCheckStatus(int code, String name) {
        this.code = code;
        this.name = name;
    }

    public static int getEnumValue(String name) {
        SalesTargetCheckStatus resultEnum = null;
        Integer code = null;
        SalesTargetCheckStatus[] enumAry = SalesTargetCheckStatus.values();
    ...
    public static SalesTargetCheckStatus getEnumName(String value) {
        SalesTargetCheckStatus resultEnum = null;
        SalesTargetCheckStatus[] enumAry = SalesTargetCheckStatus.values();
        for (int i = 0; i < enumAry.length; i++) {

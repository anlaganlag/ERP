...
public enum SettlementReportStatus {
    ...
    SettlementReportStatus(int code, String name) {
        this.code = code;
        this.name = name;
    }

    public static SettlementReportStatus getEnumValue(String name) {
        SettlementReportStatus resultEnum = null;
        SettlementReportStatus[] enumAry = SettlementReportStatus.values();
    ...
    public static SettlementReportStatus getEnumName(String value) {
        SettlementReportStatus resultEnum = null;
        SettlementReportStatus[] enumAry = SettlementReportStatus.values();
        for (int i = 0; i < enumAry.length; i++) {

...
public class ProfitTargetResult implements Serializable, BaseValidatingParam {
    ...
    @ExcelProperty(value = "年度利润目标")
    private BigDecimal yearTarget;

    /** 年度利润率 */
    @ContentStyle(dataFormat = 2)
    @ApiModelProperty("PROFIT_MARGIN")
    @ExcelProperty(value ="年度利润率")
    private BigDecimal yearProfitMargin;

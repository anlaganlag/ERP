...
@Slf4j
public class TeamVerifyCellWriteHandler extends AbstractColumnWidthStyleStrategy implements CellWriteHandler {
    ...
    private void setFormula2(Cell cell) {
        ...
        //需要设置公式的列
        if (colNum == 62 || colNum == 72  || colNum == 83 || colNum == 84 || colNum == 85 || colNum == 86 || colNum == 87) {

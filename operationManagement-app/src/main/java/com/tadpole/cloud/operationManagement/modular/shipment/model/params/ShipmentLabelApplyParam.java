...
@AllArgsConstructor
@NoArgsConstructor
public class ShipmentLabelApplyParam extends BaseRequest implements Serializable,BaseValidatingParam{
 private static final long serialVersionUID = 1L;
   ...
   @ApiModelProperty(value = "物料编码List")
    ...
    @ApiModelProperty(value = "ASIN list")
   ...
   /** 站点 */
   @ApiModelProperty(value = "站点 list")
   ...
   /** 店铺名称-简称账号 */
   @ApiModelProperty(value = "店铺名称-简称账号 List")
   ...
   /** 调拨单号;同步到k3的调拨单号 */
   @ApiModelProperty(value = "调拨单号 list")

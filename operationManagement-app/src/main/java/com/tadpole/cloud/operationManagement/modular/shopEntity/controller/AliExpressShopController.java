...
@Api(tags = "速卖通店铺接口")
@RestController
@ApiResource(name="速卖通资源-店铺" , path="/SMTShops")
public class AliExpressShopController {

    public final String paginQueryFunName = "速卖通店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("AliExpress");
       //2.分页查询

...
@Data
@Getter
@ApiModel("采购申请单查询请求参数VO类")
public class PurchaseOrdersReqVO extends BaseRequest {
    ...
    public class Eform {
        ...
        @ApiModelProperty("申请备货后周转天数-最小值")
        private BigDecimal turnoverDaysLow;

        @ApiModelProperty("申请备货后周转天数-最大值")
        private BigDecimal turnoverDaysHeight;

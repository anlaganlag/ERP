...
public class TeamVerifResultV3 implements Serializable, BaseValidatingParam {
...
//    @ExcelProperty("申请备货原因")
    ...
    /** 汇总数据id拼接*/
    @ApiModelProperty("合并数据审核状态")
    private String verifStatusName;

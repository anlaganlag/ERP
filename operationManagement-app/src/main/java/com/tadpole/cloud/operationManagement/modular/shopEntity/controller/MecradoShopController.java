...
@Api(tags = "美客多店铺接口")
@RestController
@ApiResource(name="美客多资源-店铺" , path="/MecradoShops")
public class MecradoShopController {

    public final String paginQueryFunName = "美客多店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("Mercadolibre");
       //2.分页查询

...
*/
@Slf4j
@Api(tags = "Walmart店铺接口")
@RestController
@ApiResource(name="资源-店铺-Walmart" , path="/WalmartShops")
public class WalmartShopController {

    public final String paginQueryFunName = "资源-店铺-Walmart--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("Walmart");
       //2.分页查询

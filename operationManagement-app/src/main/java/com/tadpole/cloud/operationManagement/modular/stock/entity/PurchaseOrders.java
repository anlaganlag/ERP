...
public class PurchaseOrders implements Serializable {
 ...
 /** 采购申请数量,默认建议采购数量，可以改动编辑    销售需求3-AZ海外总库存D4-国内可用库存-采购未交订单    */
 ...
 /**申请备货后周转天数： 取值来源：实时计算：销售需求3/日均销量D4 **/

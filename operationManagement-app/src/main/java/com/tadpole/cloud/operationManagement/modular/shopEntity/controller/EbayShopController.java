...
@Api(tags = "Ebay店铺接口")
@RestController
@ApiResource(name="Ebay资源-店铺" , path="/EbayShops")
public class EbayShopController {

    public final String paginQueryFunName = "Ebay店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("eBay");
       //2.分页查询

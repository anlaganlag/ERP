...
@Api(tags = "乐天店铺接口")
@RestController
@ApiResource(name="乐天资源-店铺" , path="/Rakutenhops")
public class RakutenShopController {

    public final String paginQueryFunName = "乐天店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("Rakuten");
       //2.分页查询

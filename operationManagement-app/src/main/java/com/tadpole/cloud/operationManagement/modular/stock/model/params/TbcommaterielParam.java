...
@AllArgsConstructor
@NoArgsConstructor
public class TbcommaterielParam implements Serializable, BaseValidatingParam {
   ...
   @TableId(value = "ID", type = IdType.AUTO)
    ...
    /** 立项编号 */
    private List<String> matProjectNos;

    /** 产品名称 */
    private String matProNameNew;

   /** 设计人员姓名 */
   private String matDesignPerName;

...
@Api(tags = "淘宝店铺接口")
@RestController
@ApiResource(name="Alibaba资源-店铺" , path="/AlibabaShops")
public class AlibabaShopController {

    public final String paginQueryFunName = "Alibaba店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("Alibaba");
       //2.分页查询

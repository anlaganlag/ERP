...
import com.tadpole.cloud.operationManagement.api.shopEntity.entity.TbComTaxAudit;
 ...
 /**
 * 资源-税号查账记录;(Tb_Com_Tax_Audit)--数据库访问层
 * @author : LSY
 * @date : 2023-7-28
 */
@Mapper
public interface TbComTaxAuditMapper  extends BaseMapper<TbComTaxAudit>{
    /** 
     * 分页查询指定行数据
     *
     * @param page 分页参数
     ...
     * @return 分页对象列表
     */
    IPage<TbComTaxAuditResult> selectByPage(IPage<TbComTaxAuditResult> page , @Param(Constants.WRAPPER) Wrapper<TbComTaxAudit> wrapper);
}
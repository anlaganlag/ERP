...
*/
@Slf4j
@Api(tags = "Shopify店铺接口")
@RestController
@ApiResource(name="Shopify资源-店铺" , path="/ShopifyShops")
public class ShopifyShopController {

    public final String paginQueryFunName = "Shopify店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("Shopify");
       //2.分页查询

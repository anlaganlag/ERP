...
@Api(tags = "来赞达店铺接口")
@RestController
@ApiResource(name="来赞达资源-店铺" , path="/LazadaShops")
public class LazadaShopController {

    public final String paginQueryFunName = "来赞达店铺--分页查询";
   ...
   public ResponseData paginQuery(@RequestBody TbComShopParam tbComShopParam){
       ...
       tbComShopParam.setElePlatformName("Lazada");
       //2.分页查询

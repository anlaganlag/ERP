...
@AllArgsConstructor
@NoArgsConstructor
@TableName("STOCK_TEAM_VERIF")
@ExcelIgnoreUnannotated
public class TeamVerif implements Serializable {
 ...
 /** 值域{"自动"/"人工"} */
 @TableField("TEAM_VERIF_TYPE")
 private String teamVerifType;

 /** 标记此推荐记录是否已进行Team审核操作，值域{"0待审核"/"1已审核/2已提交/3超时不备货"}默认值：待审核 */
 @TableField("VERIF_STATUS")

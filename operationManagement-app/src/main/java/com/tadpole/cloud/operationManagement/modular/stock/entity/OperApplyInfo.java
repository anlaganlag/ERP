...
public class OperApplyInfo implements Serializable {
 ...
 /** 备货状态--标记此推荐记录是否已进行备货申请操作，值域{"0:待申请,1:已提交,2:已申请,3:超时不备货"}默认值：待申请 */

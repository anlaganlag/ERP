...
* @date : 2023-12-29
*/
@ApiModel(value = "亚马逊货件查询返回模型",description = "")
@Data
...
public class TbLogisticsPackListResultModel implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   /** shipmentType  */
   @ApiModelProperty(value = "shipmentType")
   @ExcelProperty(value ="货件来源")

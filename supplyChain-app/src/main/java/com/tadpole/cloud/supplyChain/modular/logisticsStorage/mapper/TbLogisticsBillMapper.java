...
/**
 * 物流账单;(tb_logistics_bill)表数据库访问层
 * @author : LSY
 * @date : 2023-12-29
 */
@Mapper
public interface TbLogisticsBillMapper  extends BaseMapper<TbLogisticsBill>{
    /** 
     * 分页查询指定行数据
     *
     * @param page 分页参数
     ...
     * @return 分页对象列表
     */
    IPage<TbLogisticsBillResult> selectByPage(IPage<TbLogisticsBillResult> page , @Param(Constants.WRAPPER) Wrapper<TbLogisticsBill> wrapper);
}
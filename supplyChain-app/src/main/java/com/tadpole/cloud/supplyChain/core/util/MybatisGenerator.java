...
public class MybatisGenerator {
  ...
  public static void main(String[] args) {
    ...
    gc.setOutputDir(projectPath + "/supplyChain-app/src/main/java");
    gc.setAuthor("ty");//创建人
    gc.setOpen(false);
...
//    strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
    strategy.setInclude("TG_COUNTRY_INFO");
...
//    strategy.setTablePrefix("STOCK_"); //生成实体时去掉表前缀
    ...
    String ModuleName = "logistics";
    // 包配置
    PackageConfig pc = new PackageConfig();
    pc.setParent("com.tadpole.cloud.supplyChain.modular." + ModuleName);
...
//                return projectPath + "/src/main/resources/mappers/" + pc.getModuleName()
        return projectPath + "/supplyChain-app/src/main/java/com/tadpole/cloud/supplyChain/modular/"
                + ModuleName
    ...
    focList.add(new FileOutConfig(paramTemplatePath) {
      @Override
      public String outputFile(TableInfo tableInfo) {
        return projectPath + "/supplyChain-api/src/main/java/com/tadpole/cloud/supplyChain/api/"
                + ModuleName

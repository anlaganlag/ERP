...
public class AccountMgtPersonalResult implements Serializable{
 private static final long serialVersionUID = 1L;
    ...
    @ExcelProperty(value ="账户(账号)")
    private String accNo ;
 
    /** 账户户名 */
    @ApiModelProperty(value = "账户户名")
    @ExcelProperty(value ="账户户名")
    private String accName ;
 
    /** 账户开户行 */
    @ApiModelProperty(value = "账户开户行")
    @ExcelProperty(value ="账户开户行")
    ...
    @ExcelProperty(value ="预存金额")
    private BigDecimal depositAmount ;
 
    /** 实时金额 */
    @ApiModelProperty(value = "实时金额")
    @ExcelProperty(value ="实时金额")

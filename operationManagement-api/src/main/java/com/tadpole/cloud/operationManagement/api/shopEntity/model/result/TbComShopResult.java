...
public class TbComShopResult  implements Serializable{
    ...
    public TbComShopResult(String comNameCN, String comAddrCN, String comLegPerson) {
        this.shopComNameCn = comNameCN;
        this.shopComAddrCn = comAddrCN;
        this.shopLegPersonCn = comLegPerson;
    }

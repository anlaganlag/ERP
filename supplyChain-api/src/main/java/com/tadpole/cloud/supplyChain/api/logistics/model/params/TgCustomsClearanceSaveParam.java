 ...
 */
@Data
public class TgCustomsClearanceSaveParam extends BaseRequest implements Serializable, BaseValidatingParam {
    ...
    private List<TgCustomsClearanceDetail> clearanceDetails;

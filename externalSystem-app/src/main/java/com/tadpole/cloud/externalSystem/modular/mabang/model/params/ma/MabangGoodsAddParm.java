...
@AllArgsConstructor
@Builder
public class MabangGoodsAddParm {
    ...
    @ApiModelProperty("申报价值")
    private String declareValue	            ;//申报价值
    ...
    private String declareCode	            ;//报关编码

    @ApiModelProperty("最新采购价")
    private String purchasePrice	            ;//最新采购价

    @ApiModelProperty("parentName")
    private String parentName;//主品牌名称（子品牌填写时，此为必填项）
    ...
    private String powder	            ;//粉末 1.是 2.否
    ...
    @ApiModelProperty("供应商不存在，是否自动创建供应商，默认2不创建")
    private String autoCreateSupplier	            ;//供应商不存在，是否自动创建供应商，默认2不创建
    ...
    @ApiModelProperty("售价")
    private String creatorName	            ;//创建员工

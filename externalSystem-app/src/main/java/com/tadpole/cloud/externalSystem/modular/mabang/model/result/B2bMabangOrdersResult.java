...
public class B2bMabangOrdersResult  implements Serializable{
 private static final long serialVersionUID = 1L;
    ...
    @ExcelProperty(value ="订单状态 2.配货中 3.已发货 4.已完成 5.已作废")
    private String orderStatus ;
    
    /** 物流渠道编号 */
    @ApiModelProperty(value = "物流渠道编号")
    @ExcelProperty(value ="物流渠道编号")
    ...
    @ExcelProperty(value ="MCMS含义:平台编码-----马帮含义:来源平台")
    ...
    @ExcelProperty(value ="1.合并订单 2.非合并订单")
    private String isUnion ;
    
    /** 1.拆分订单 2.非拆分订单 */
    @ApiModelProperty(value = "1.拆分订单 2.非拆分订单")
    @ExcelProperty(value ="1.拆分订单 2.非拆分订单")
    private String isSplit ;
    
    /** 1.重发订单 2.非重发订单 */
    @ApiModelProperty(value = "1.重发订单 2.非重发订单")
    @ExcelProperty(value ="1.重发订单 2.非重发订单")
...
1有货 2缺货 3已补货)---马帮含义:缺货订单 0 正在计算是否缺货 、 1有货、2缺货、3 已补货 */
    ...
    @ExcelProperty(value ="MCMS含义:缺货状态(0正在计算是否缺货 1有货 2缺货 3已补货)---马帮含义:缺货订单 0 正在计算是否缺货 、 1有货、2缺货、3 已补货")
    private String hasGoods ;
    
    /** 是否含电池 1.是 2否 */
    @ApiModelProperty(value = "是否含电池 1.是 2否")
    @ExcelProperty(value ="是否含电池 1.是 2否")
    private String hasBattery ;
    
    /** MCMS含义:订单获取物流跟踪号描述-----马帮含义:交运结果描述 */
    @ApiModelProperty(value = "MCMS含义:订单获取物流跟踪号描述-----马帮含义:交运结果描述")
    @ExcelProperty(value ="MCMS含义:订单获取物流跟踪号描述-----马帮含义:交运结果描述")
    ...
    @ExcelProperty(value ="MCMS含义:用户支付的paypal Id-----马帮含义:paypalId")
    private String paypalId ;
    
    /** MCMS含义:订单获取物流跟踪号状态(0未调用;1 开始调用 */
    @ApiModelProperty(value = "MCMS含义:订单获取物流跟踪号状态(0未调用")
    @ExcelProperty(value ="MCMS含义:订单获取物流跟踪号状态(0未调用")
...
7同步失败 9同步成功)---马帮含义:是否同步到电商平台 1未同步 2等待交运 6不需要同步 7同步失败 9同步成功 */
    ...
    @ExcelProperty(value ="MCMS含义:币种汇率-----马帮含义:汇率")
    ...
    @ExcelProperty(value ="MCMS含义:是否已转至仓库系统发货-----马帮含义:1.wms 2.非wms")
    ...
    @ExcelProperty(value ="VendorID  注意：字段首字母大写，字段赋值可能为空")
    ...
    @ExcelProperty(value ="MCMS含义:Australian Business Number,澳大利亚商业编号(每一个企业都有自己独一无二的ABN， 且ABN并不等同于税号（TFN），企业也需要申请自己的税号。)---马帮含义:税号")
    ...
    @ExcelProperty(value ="MCMS含义:马帮ERP系统订单编号-----马帮含义:ERP系统订单编号   注意：字段首字母大写，字段赋值可能为空")
    private String erpOrderId ;
    
    /** MCMS含义:包裹实际物流重(物流公司称重)---马帮含义:物流称重 */
    @ApiModelProperty(value = "MCMS含义:包裹实际物流重(物流公司称重)---马帮含义:物流称重")
    @ExcelProperty(value ="MCMS含义:包裹实际物流重(物流公司称重)---马帮含义:物流称重")
    private BigDecimal shippingWeight ;
    
    /** 作废前状态，参考orderStatus字段 */
    @ApiModelProperty(value = "作废前状态，参考orderStatus字段")
    @ExcelProperty(value ="作废前状态，参考orderStatus字段")
    ...
    @ExcelProperty(value ="注意：字段首字母大写，字段赋值可能为空")
    private String extendAttr ;
    
    /** 同步方式（0 ：系统同步,1：手动人工同步） */
    @ApiModelProperty(value = "同步方式（0 ：系统同步,1：手动人工同步）")
    @ExcelProperty(value ="同步方式（0 ：系统同步,1：手动人工同步）")
    ...
    /** 订单明细项List */
    @ApiModelProperty(value = "订单明细项List")
    private List<B2bMabangOrderItem> orderitemList ;

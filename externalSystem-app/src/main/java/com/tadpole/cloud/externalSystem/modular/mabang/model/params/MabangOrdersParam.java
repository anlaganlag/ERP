...
public class MabangOrdersParam implements Serializable, BaseValidatingParam {
     ...
     */
    @ApiModelProperty("MCMS含义:订单下载至马帮ERP时间-----马帮含义:订单同步ERP时间")
     ...
     */
    @ApiModelProperty("MCMS含义:平台编码-----马帮含义:来源平台")
    ...
    @ApiModelProperty("CREATE_CROSS_TRANSFER")
    private BigDecimal createCrossTransfer;

    /**
     * 是否创建销售出库单（0 ：默认0未创建,1：已创建,5：非限定平台)
     */
    @ApiModelProperty("CREATE_SALE_OUT_ORDER")

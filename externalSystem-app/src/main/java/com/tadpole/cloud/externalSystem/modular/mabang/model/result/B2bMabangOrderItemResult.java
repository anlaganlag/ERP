...
public class B2bMabangOrderItemResult  implements Serializable{
 private static final long serialVersionUID = 1L;
    ...
    @ExcelProperty(value ="MCMS含义:商品成本价-----马帮含义:商品成本价")
    ...
    @ExcelProperty(value ="MCMS含义:商品编号(从平台抓取的商品编号)---马帮含义:马帮订单商品编号")
    private String orderItemId ;
    
    /** MCMS含义:马帮商品编号(马帮表中的商品编号ID)---马帮含义:马帮订单商品编号 */
    @ApiModelProperty(value = "MCMS含义:马帮商品编号(马帮表中的商品编号ID)---马帮含义:马帮订单商品编号")
    @ExcelProperty(value ="MCMS含义:马帮商品编号(马帮表中的商品编号ID)---马帮含义:马帮订单商品编号")
...
2液体(化妆品) 3液体(非化妆品))---马帮含义:0:非液体,2:液体(化妆品),1:非液体(化妆品),3:液体(非化妆品) */
    ...
    @ExcelProperty(value ="MCMS含义:液体和化妆品说明(0非液体 1非液体(化妆品) 2液体(化妆品) 3液体(非化妆品))---马帮含义:0:非液体,2:液体(化妆品),1:非液体(化妆品),3:液体(非化妆品)")
    ...
    @ExcelProperty(value ="MCMS含义:库存SKU状态(1自动创建 2待开发 3正常 4清仓 5停止销售)---马帮含义:状态：1.自动创建2.待开发3.正常4.清仓5.停止销售")
    private String stockStatus ;
    
    /** MCMS含义:商品仓库编号-----马帮含义:商品仓库编号 */
    @ApiModelProperty(value = "MCMS含义:商品仓库编号-----马帮含义:商品仓库编号")
    @ExcelProperty(value ="MCMS含义:商品仓库编号-----马帮含义:商品仓库编号")
    private String stockWarehouseId ;
    
    /** MCMS含义:商品名称-----马帮含义:商品名称 */
    @ApiModelProperty(value = "MCMS含义:商品名称-----马帮含义:商品名称")
    @ExcelProperty(value ="MCMS含义:商品名称-----马帮含义:商品名称")
    ...
    @ExcelProperty(value ="MCMS含义:平台transactionId(这个字段拉一下值看看)---马帮含义:平台transactionId")
    private String transactionId ;
    
    /** MCMS含义:单品重量-----马帮含义:商品单品重量 */
    @ApiModelProperty(value = "MCMS含义:单品重量-----马帮含义:商品单品重量")
    @ExcelProperty(value ="MCMS含义:单品重量-----马帮含义:商品单品重量")
    private BigDecimal unitWeight ;
    
    /** MCMS含义:商品仓库名称-----马帮含义:商品仓库名称 */
    @ApiModelProperty(value = "MCMS含义:商品仓库名称-----马帮含义:商品仓库名称")
    @ExcelProperty(value ="MCMS含义:商品仓库名称-----马帮含义:商品仓库名称")

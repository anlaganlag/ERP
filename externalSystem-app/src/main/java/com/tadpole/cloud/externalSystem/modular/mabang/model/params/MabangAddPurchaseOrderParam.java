...
public class MabangAddPurchaseOrderParam extends BaseRequest implements Serializable, BaseValidatingParam {
   ...
   @ApiModelProperty("K3调拨单审核开始日期")
   private Date approveStartDate;

   @ApiModelProperty("K3调拨单审核结束日期")
   private Date approveEndDate;



   @ApiModelProperty("K3调拨单创建开始日期")
   private Date createStartDate;

   @ApiModelProperty("K3调拨单创建结束日期")
   private Date createEndDate;


   @ApiModelProperty("推送马帮开始日期")
   private Date syncStartDate;

   @ApiModelProperty("推送马帮结束日期")
